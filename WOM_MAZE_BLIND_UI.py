...
class BlindMazeApp(ctk.CTk):
    """Window for Blind Maze variant solver."""
    def __init__(self):
        super().__init__()
        self.title('Blind Maze')
        self.state('zoomed')
        ...
        # Header
        header = ctk.CTkFrame(main_container, fg_color='#1E90FF')  # Dodger blue color
        header.pack(fill=tk.X, pady=(0, 10))
        ctk.CTkLabel(header, text='Blind Maze', 
                    font=('Arial', 24, 'bold'), 
        ...
        # Left control panel
        control = ctk.CTkFrame(content, width=300, fg_color='#1E90FF')  # Dodger blue color
    ...
    def generate_maze(self):
        """Generate a new maze."""
        n = self.grid_size
        self.grid_data = logic.generate_maze(n, self.maze_type.get(), 'Blind Maze')
